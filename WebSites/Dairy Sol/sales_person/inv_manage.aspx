<%@ Page Title="" Language="C#" MasterPageFile="~/sales_person/MasterSales.master" AutoEventWireup="true" CodeFile="inv_manage.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="page-wrapper" style="height:93vh">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="del_product_GridView" runat="server" AutoGenerateColumns="False" DataKeyNames="product_id" DataSourceID="SqlDataSource1" AllowSorting="True" BackColor="White" CssClass="table table-bordered table-hover table-striped">
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderText="Details" NavigateUrl="~/site_prod_detail.aspx?id={0}" Text="View" DataNavigateUrlFields="product_id" DataNavigateUrlFormatString="~/site_prod_detail.aspx?id={0}"/>
                            </Columns>
