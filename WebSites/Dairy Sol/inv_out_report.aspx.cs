...
public partial class inv_out_report : System.Web.UI.Page
{
    ...
    private void showReport()
    {
        ...
        rptViewer.LocalReport.ReportPath = "invOut_Report.rdlc";
    ...
    private DataTable GetData(DateTime fromDate, DateTime toDate)
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("InventoryOut", cn);
