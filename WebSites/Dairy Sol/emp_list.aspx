<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="emp_list.aspx.cs" Inherits="_Default" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-4">
				        <div class="input-group" style="margin-top: 55px">
					        ...
					        <asp:TextBox runat="server" type="text" class="form-control control-height" placeholder="Search by Name" ID="search"/>
					...
					<div class="col-lg-12">
                        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AllowPaging="true" AutoGenerateColumns="False" BackColor="White" CssClass="table table-bordered table-hover table-striped" GridLines="None"  DataKeyNames="employee_id" DataSourceID="SqlDataSource1">
                            <Columns>
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="employee_id" DataNavigateUrlFormatString="emp_profile.aspx?id={0}" Text="View" HeaderText="Full Profile"></asp:HyperLinkField>
                            </Columns>
